...
The RdiClient for Java is currently in beta and the current version is 0.12. [Click here](https://metamx.github.io/rdi-client-java/static/apidocs/0.12/) for the full javadocs.  You may also [view the source on Github](https://github.com/metamx/rdi-client-java/).
...
For more information on the core RdiClient API, please refer to the javadocs [here](https://metamx.github.io/rdi-client-java/static/apidocs/0.12/).
